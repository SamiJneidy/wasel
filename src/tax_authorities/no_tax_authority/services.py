...
class NoTaxAuthorityService(TaxAuthorityService):
    ...
    async def sign_and_submit_invoice(self, user: UserInDB, invoice: SaleInvoiceOut, metadata: dict = {}) -> None:
        """
    ...
    async def get_branch_tax_authority_data(self, user: UserInDB, branch_id: int, tax_integration_status: BranchTaxIntegrationStatus) -> None:
        return None
